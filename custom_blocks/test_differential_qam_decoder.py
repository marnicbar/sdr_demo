...
class test_differential_qam_decoder(gr_unittest.TestCase):
    ...
    def generate_qam_test_data(self, order):
        ...
        src_data = quadrant << order.value*2 | symbol_part_in_quadrant
        expected = quadrant_diff << order.value*2 | symbol_part_in_quadrant
    ...
    def test_qam4(self):
        ...
        enc = differential_qam_decoder(order=qam.QAM4)
    ...
    def test_qam16(self):
        ...
        src = blocks.vector_source_b(src_data.tolist(), False)
        enc = differential_qam_decoder(order=qam.QAM16)
        sink = blocks.vector_sink_b()
    ...
    def test_qam64(self):
        ...
        src = blocks.vector_source_b(src_data.tolist(), False)
        enc = differential_qam_decoder(order=qam.QAM64)
        sink = blocks.vector_sink_b()
    ...
    def test_qam256(self):
        ...
        src = blocks.vector_source_b(src_data.tolist(), False)
        enc = differential_qam_decoder(order=qam.QAM256)
        sink = blocks.vector_sink_b()
...
if __name__ == '__main__':
    gr_unittest.run(test_differential_qam_decoder)
